...
// Document properties
:doctitle: D2.8.III.3 INSPIRE Data Specification on _Soil_ – Draft Guidelines
:creator: INSPIRE Thematic Working Group _Soil_
:revdate: 2013-12-10
:keywords: INSPIRE Data Specification for the spatial data theme _Soil_
...
:author: Members of the INSPIRE Thematic Working Group _Soil_
:copyright: Public
:revremark: 
:lang: en
